...
router.post("/", function(req, res, next) {
    ...
    request(options, function(err, response, body) {
      ...
      if (!err && response.statusCode === 200){
          ...
          var returnTable='<table align="center" cellspacing=\'0\' border=\'1\'>\
                    ...
                    <tr><th width=\'20%\'>Game</th><th width=\'70%\' colspan="' + games + '">Numbers</th><th width=\'10%\'>Powerball</th></tr>';
          for (i=0;i<body.length;i++){
            ...
            for(k=0;k<num_array.length;k++){
              returnTable = returnTable + '\
              <td width=\'' + col_w + '%\'>' + num_array[k] + '</b></td>';
            }
            returnTable = returnTable + '\
            <td width=\'10%\'>' + body[i]["powerball"] + '</b></td>';
            returnTable = returnTable + '\
            </tr>'
          }
          returnTable = returnTable + '\
  ...
  console.log("Powerball route Called")
});
